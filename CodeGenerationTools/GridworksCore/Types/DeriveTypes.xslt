        ...
        <FileSet>
            <FileSetFiles>
                ...
                <xsl:variable name="python-class-name">
                    ...
                    <FileSetFile>
                                <xsl:element name="RelativePath"><xsl:text>../../../src/gwbase/types/</xsl:text>
...
<xsl:text>
from gwbase.data_classes.</xsl:text>
...
<xsl:text>
from gwbase.data_classes.components.</xsl:text>
<xsl:call-template name="python-case">
    <xsl:with-param name="camel-case-text" select="translate(DataClass,'.','_')"  />
</xsl:call-template>
<xsl:text> import </xsl:text><xsl:value-of select="DataClass"/>
...
<xsl:text>
from gwbase.data_classes.cacs.</xsl:text>
<xsl:call-template name="python-case">
    <xsl:with-param name="camel-case-text" select="translate(DataClass,'.','_')"  />
</xsl:call-template>
<xsl:text> import </xsl:text><xsl:value-of select="DataClass"/>
