...
class MessageCategory(GwStrEnum):
    ...
    Values (with symbols in parens):
      ...
      - RabbitJsonDirect (9057ab24): Serialized Json message sent on the world rabbit broker from
        one GNode actor to another
      - RabbitJsonBroadcast (7813eb50): Serailized Json message broadcast on the world rabbit broker
        by a GNode actor
      - RabbitGwSerial (9d70744e): GwSerial protocol message sent on the world rabbit broker
      - MqttJsonBroadcast (16594e91): Serialized Json message following MQTT topic format, sent on
