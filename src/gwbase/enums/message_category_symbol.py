...
class MessageCategorySymbol(GwStrEnum):
    ...
    Values (with symbols in parens):
      ...
      - rj (7e4957a3): Serialized Json message sent on the world rabbit broker from one GNode actor
        to another
      - rjb (68bb105c): Serailized Json message broadcast on the world rabbit broker by a GNode actor
      - s (eb802736): GwSerial protocol message sent on the world rabbit broker
      - gw (f36a8e69): Serialized Json message following MQTT topic format, sent on the world rabbit
        broker
