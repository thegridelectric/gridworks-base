...
class StrategyName(GwStrEnum):
    ...
    Values:
      ...
      - WorldA: Authority on GNodeInstances, and their private keys. Maintains a FastAPI
      ...
      - SupervisorA: A simple supervisor that monitors its supervised AtomicTNode GNode
        strategies via a heartbeat health check. [More Info](https://gridworks.readthedocs.io/en/latest/supervisor.html)
      - AtnHeatPumpWithBoostStore: AtomicTNode for a heat pump thermal storage heating
      ...
      - MarketMakerA: Runs a two-sided market associated to its GNode as part of the copper
        GNode sub-tree. [More on MarketMakers](https://gridworks.readthedocs.io/en/latest/market-maker.html)
      - AtnBrickStorageHeater: Publicly available Dijkstra-based AtomicTNode strategy
