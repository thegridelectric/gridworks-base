...
class UniverseType(GwStrEnum):
    ...
    Enum universe.type version 000 in the GridWorks Type registry.
    ...
    Values (with symbols in parens):
      - Dev (00000000): Simulation running on a single computer.
      - Hybrid (8281a0fa): Anything goes.
      - Production (b0168bda): Money at stake.
    """
    ...
    def default(cls) -> "UniverseType":
        """
        Returns default value (in this case Dev)
        """
        return cls.Dev
    ...
    def enum_name(cls) -> str:
        """
        The name in the GridWorks Type Registry (universe.type)
        """
    ...
    def symbol_to_value(cls, symbol: str) -> str:
        ...
        Returns:
            ...
            a later version of this enum, returns the default value of "Dev".
        """
    ...
    def value_to_symbol(cls, value: str) -> str:
        """
        Provides the encoding symbol for a UniverseType enum to send in seriliazed messages.
