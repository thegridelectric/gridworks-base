...
class SupervisorContainerGt(BaseModel):
    ...
    def as_dict(self) -> Dict[str, Any]:
        ...
        supervisor.container.gt.000 object.

        This method prepares the object for serialization by the as_type method, creating a
        dictionary with key-value pairs that follow the requirements for an instance of the
        supervisor.container.gt.000 type. Unlike the standard python dict method,
    ...
    def as_type(self) -> bytes:
        """
        Serialize to the supervisor.container.gt.000 representation.

        Instances in the class are python-native representations of supervisor.container.gt.000
        objects, while the actual supervisor.container.gt.000 object is the serialized UTF-8 byte
        ...
        Its near-inverse is SupervisorContainerGt.type_to_tuple(). If the type (or any sub-types)
...
class SupervisorContainerGt_Maker:
    ...
    @classmethod
    def type_to_tuple(cls, t: bytes) -> SupervisorContainerGt:
        """
    ...
    def dict_to_tuple(cls, d: dict[str, Any]) -> SupervisorContainerGt:
        """
        Deserialize a dictionary representation of a supervisor.container.gt.000 message object
        into a SupervisorContainerGt python object for internal use.

        This is the near-inverse of the SupervisorContainerGt.as_dict() method:
        ...
        Raises:
           GwTypeError: if the dict cannot be turned into a SupervisorContainerGt object.
